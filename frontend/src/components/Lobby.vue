      ...
      >
        <div class="help-content" style="max-height: 70vh; overflow-y: auto; padding-right: 10px;">
          ...
          <ul>
            ...
            <li>预游戏阶段（房间内）：
              <ul>
                ...
                <li>补充筹码（Cash In）：空闲阶段可补充1000筹码（德州扑克）。</li>
                <li>带走筹码并退出（Cash Out）：仅可在空闲阶段退出房间并清除本地状态。</li>
          ...
          <div class="game-help-section">
            ...
            <p><strong>发牌模式：</strong>可选择线上系统发牌，或线下发牌模式（系统仅管理流程/筹码，赢家手动领取（Take）底池）。</p>
          ...
          <el-form :model="createRoomForm" label-width="120px">
            ...
            <template v-if="createRoomForm.gameType === 'texas-holdem'">
              ...
              <el-form-item label="发牌模式">
                ...
                <div class="form-tip">
                  线下发牌模式只管理流程、下注与底池；系统不显示手牌/公共牌，结算时由赢家领取筹码。
                </div>
              </el-form-item>
            </template>
